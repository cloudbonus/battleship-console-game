...
public class ConsoleDisplayManager {
    ...
    public static String getGameInfo(Player player, String opponentName, int totalTurns) {
        StringBuilder sb = new StringBuilder();
        String gameHeader = createGameHeader();
        sb.append(gameHeader);

        String boardNamesHeader = createBoardNamesHeader(player.getName(), opponentName);
        sb.append(boardNamesHeader);

        int userCount = player.getLeftBoard().getRemainingShipsCount();
        int opponentCount = player.getRightBoard().getRemainingShipsSum();
        ...
        String[] remainingShips = player.getRightBoard().getShipsState().split("\n");
    ...
    public static void printGameSetup(Player player) {
        printHeader();
        welcomeUser(player.getName());
        printGameModeMenu();
